...
import sinavtest1.utilities.ConfigurationReader;
import sinavtest1.utilities.Driver;
...
public class TestBase {
    ...
    public void tearDownMethod(ITestResult result) throws IOException {
        if (result.getStatus() == ITestResult.FAILURE) {//When test case fails, then take the screenshot and attached the report
            String screenshotLocation = ReusableMethod.getScreenshot(result.getName());//getScreenshot is coming from ReusableMethods
